...
- The project is inspired by the basic principles of email protocols like SMTP and IMAP.
- Thanks to the community contributions for the libraries and tools used in this project.
```
